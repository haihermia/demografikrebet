<form enctype="multipart/form-data" class="needs-validation" action="<?php echo site_url('umkm/save') ?>" method="post"
    ...
    <label style="font-weight: bold;">Id UMKM</label><br>
    <input type="text" name="id_umkm" value=""
    ...
    <input type="text" name="nama" value=""
        style="width: 100%; padding: 8px; margin-bottom: 15px; border: 1px solid #007bff; border-radius: 5px;">
    <p></p>
    <label style="font-weight: bold;">Lokasi</label><br>
    <input type="text" name="lokasi" value=""
        style="width: 100%; padding: 8px; margin-bottom: 15px; border: 1px solid #007bff; border-radius: 5px;">
    <p></p>
    <label style="font-weight: bold;">Img UMKM</label><br>
    <input type="file" name="img_umkm" value=""
        style="width: 100%; padding: 8px; margin-bottom: 15px; border: 1px solid #007bff; border-radius: 5px;">
    <p></p>
    ...
    <p></p>
    <label style="font-weight: bold;">Maps</label><br>
    ...
    <a href="<?php echo site_url('umkm') ?>" style="text-decoration: none; display: inline-block; width: 48%;">
