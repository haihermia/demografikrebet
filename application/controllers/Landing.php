...
{
    private $view = "backend/v_landing/";
    private $redirect = "Landing";
    ...
    public function index()
    {
       ...
       control Home */
       $this->template->load('backend/template_land', $this->view . 'read', $data);
    ...
    public function umkm() {
        ...
        $this->template->load('backend/template_land', $this->view . 'umkm', $data);
